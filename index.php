...
<body>
  ...
  <div class="main-banner header-text" id="top">
    <div class="Modern-Slider">
      ...
      $get_q = "SELECT * FROM banners WHERE read_status = 1";
      $banner_from_db = mysqli_query($db, $get_q);
      foreach ($banner_from_db as $banners) :
      ?>
        <!-- Item -->
        <div class="item item-1">
          <div class="img-fill" style="background-image: url(<?php echo $banners['image_location'] ?>);">
            <div class="text-content">
              <!-- <h6>we are ready to help you</h6> -->
              <h6><?php echo $banners['ban_sub_title'] ?></h6>
              <!-- <h4>Financial Analysis<br>&amp; Consulting</h4> -->
              <h4><?php echo $banners['ban_title'] ?></h4>
  ...
  <div class="services">
    <div class="container">
      <div class="row">
        ...
        <!-- service item starts -->
        <?php
        $get_query_item = "SELECT * FROM service_items
          ...
          <div class="col-md-4">
            <div class="service-item">
              ...
              <div class="down-content">
                <h4><?= $items['item_heading'] ?></h4>
                <!-- <p>Sed tincidunt dictum lobortis. Aenean tempus diam vel augue luctus dignissim. Nunc ornare leo tortor.</p> -->
                <p><?= $items['item_details'] ?></p>
            ...
            <form id="contact" action="Admin/guest_message_post.php" method="post">
              <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12">
                  <fieldset>
                    <input name="g_name" type="text" class="form-control" id="name" placeholder="Full Name" required="">
                  </fieldset>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12">
                  <fieldset>
                    <input name="g_email" type="text" class="form-control" id="email" pattern="[^ @]*@[^ @]*" placeholder="E-Mail Address" required="">
                  </fieldset>
                </div>
                ...
                <div class="col-lg-12">
                  <fieldset>
                    <textarea name="g_message" rows="6" class="form-control" id="message" placeholder="Your Message" required=""></textarea>
                  </fieldset>
                </div>
                <div class="col-lg-12">
                  <fieldset>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-3 footer-item last-item">
          <h4>Contact Us</h4>
          <div class="contact-form">
            <form id="contact footer-contact" action="Admin/guest_message_post.php" method="post">
              <div class="row">
